...
* [microsoft/msquic](https://github.com/microsoft/msquic) - Cross-platform implementation of the IETF QUIC protocol.
...
* [m0nad/Diamorphine](https://github.com/m0nad/Diamorphine) - LKM rootkit for Linux Kernels 2.6.x/3.x/4.x/5.x (x86 and x86_64)
...
* [ideawu/c1000k](https://github.com/ideawu/c1000k) - A tool to test if your OS supports 1 million connections(c1000k)
...
* [rui314/chibicc](https://github.com/rui314/chibicc) - chibicc
...
* [open5gs/open5gs](https://github.com/open5gs/open5gs) - Open5GS is a C-language Open Source implementation for 5GC (5G Core) and EPC, i.e. the core network of NR/LTE network (Release-16)
