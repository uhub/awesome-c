...
* [Softmotions/ejdb](https://github.com/Softmotions/ejdb) - EJDB 2.0 — Embeddable JSON Database engine
...
* [cetus-tools/cetus](https://github.com/cetus-tools/cetus) - 专注于稳定、性能和分布式事务的MySQL数据库中间件
...
* [mapserver/mapserver](https://github.com/mapserver/mapserver) - Source code of the MapServer project.  Please submit bug fixes for the 7.2 release, to branch-7-2
...
* [FSX/misaka](https://github.com/FSX/misaka) - A Python binding for Hoedown. Feature complete, now in maintenance mode.
...
* [iqiyi/xCrash](https://github.com/iqiyi/xCrash) - 🔥 A crash reporting library for Android APPs. Support catching native crash and Java exception. Support Android 4.0 - 9.0 (API level 14 - 28). Support armeabi, armeabi-v7a, arm64-v8a, x86 and x86_64.
...
* [losnoco/vgmstream](https://github.com/losnoco/vgmstream) - Git clone of the vgmstream - A library for playback of various streamed audio formats used in video games.
...
* [SharpAI/DeepCamera](https://github.com/SharpAI/DeepCamera) - Open source AI-powered video surveillance on embedded Linux/Android with ARM GPU/NPU support, featuring face recognition, human shape recognition(ReID), etc. The world's first AutoML Deep Learning edge AI platform.
