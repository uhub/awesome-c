...
* [cirosantilli/linux-kernel-module-cheat](https://github.com/cirosantilli/linux-kernel-module-cheat) - The perfect setup to study and modify the Linux kernel, kernel modules, QEMU and gem5. Highly automated and documented. GDB and KGDB just work. Powered by Buildroot and Docker. "Tested" in Ubuntu 18.04 host, x86 and ARM guests with kernel v4.18.
