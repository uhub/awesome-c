...
* [mapserver/mapserver](https://github.com/mapserver/mapserver) - Source code of the MapServer project.  Please submit bug fixes for the upcoming 7.4 release, to branch-7-4
