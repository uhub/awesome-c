...
* [babelouest/ulfius](https://github.com/babelouest/ulfius) - Web Framework for REST API in C, using JSON or not, with websockets or not, with streaming data or not
