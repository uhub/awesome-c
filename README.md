...
* [altdesktop/playerctl](https://github.com/altdesktop/playerctl) - 🎧 mpris command-line controller for vlc, mpv, RhythmBox, web browsers, cmus, mpd, spotify and others.
...
* [session-replay-tools/cetus](https://github.com/session-replay-tools/cetus) - 专注于稳定、性能和分布式事务的MySQL数据库中间件（其中性能测试在开源数据库中间件排名第一）
...
* [eclipse/paho.mqtt.c](https://github.com/eclipse/paho.mqtt.c) - An Eclipse Paho C client library for MQTT for Windows, Linux and MacOS. API documentation at https://eclipse.github.io/paho.mqtt.c/
...
* [dibyendumajumdar/ravi](https://github.com/dibyendumajumdar/ravi) - Ravi is a dialect of Lua, featuring limited optional static typing and JIT compilers
...
* [MapServer/MapServer](https://github.com/MapServer/MapServer) - Source code of the MapServer project.  Please submit pull requests to the 'master' branch.
...
* [susam/uncap](https://github.com/susam/uncap) - Map Caps Lock key to Escape key on Windows (with Uncap), Linux (with setxkbmap), and macOS (with System Preferences)
...
* [jvoisin/snuffleupagus](https://github.com/jvoisin/snuffleupagus) - Security module for php7 - Killing bugclasses and virtual-patching the rest!
...
* [zpl-c/zpl](https://github.com/zpl-c/zpl) - 📐 Your (almost) C99 Powerkit
...
* [chenyahui/AnnotatedCode](https://github.com/chenyahui/AnnotatedCode) - 知名开源代码库的注释版，包括libco、coroutine、muduo等
...
* [sheredom/json.h](https://github.com/sheredom/json.h) - single header json parser for C and C++
...
* [pbatard/uefi-ntfs](https://github.com/pbatard/uefi-ntfs) - UEFI:NTFS - Boot NTFS partitions from UEFI
