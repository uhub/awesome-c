...
* [asamy/ksm](https://github.com/asamy/ksm) - A really simple and lightweight x64 hypervisor written in C for Windows (Intel processors).  Supports VMFUNC, EPTP switching, #VE EPT Violation, VT-x nesting and IDT shadowing.  VMFUNC backward compatibility also supported.
...
* [dreamsxin/cphalcon7](https://github.com/dreamsxin/cphalcon7) - C语言开发高性能PHP7框架继承自Phalcon1.3
