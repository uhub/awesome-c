...
* [daniel-araujo/proctal](https://github.com/daniel-araujo/proctal) - Proctal gives you access to the address space of a program on Linux with a command line tool and a C API.
