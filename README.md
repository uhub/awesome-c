...
* [Microsoft/checkedc](https://github.com/Microsoft/checkedc) - Checked C is an extension to C that adds bounds checking and other checking.  This repo has a wiki for Checked C, sample code, the specification, and test code.
...
* [h2o/picotls](https://github.com/h2o/picotls) - TLS 1.3 implementation in C (master is on draft-26; use draftNN branches for older ones)
...
* [sisong/HDiffPatch](https://github.com/sisong/HDiffPatch) - binary data Diff & Patch  C\C++ library, and file Diff & Patch tools, fast and small differential; support large files and limit memory requires when diff&patch.
